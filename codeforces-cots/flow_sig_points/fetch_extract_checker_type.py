...
def main(
    ...
    dep_outf = ctx.flowd.parent/f'flow_main/out/extract_checker_type{tag_suffix}/checker-types.jsonl'
    outf = ctx.flow_outd/'fetch_extract_checker_type/checker-types.jsonl'
    if not link:
