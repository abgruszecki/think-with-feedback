...
PROMPT_TEMPLATE =\
'''\
The user is solving a competetive programming problem and wrote a Python code snippet to solve it, \
together with text reasoning about the code.
...
INSTRUCTIONS=\
'''\
The Python snippet works by reading the standard input and writing to the standard output. \
The text fragment should start by predicting what output the snippet produces on some inputs. \
Your task is to find those inputs and output predictions in the text, and put them into this JSON format:
```json
{
